...
app.post('/cleaning', urlencodedParser, function (req, res) {  
  ...
  console.log(response);  
	...
	MongoClient.connect(url, function(err, db) {
	  ...
	  var query = response;
	  dbo.collection("room_cleaning").insertOne(response, function(err, res) {
	    	if (err) throw err;
	    	console.log("1 new room cleaning complain added");
	    	db.close();
	  		});
		});
